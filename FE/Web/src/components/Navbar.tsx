...
export default function Navbar() {
  const [textBlack, setTextBlack] = React.useState<boolean>(
      ...
      >
        <div className="flex gap-5 items-center">
          ...
          {navLinks.map((data, index) => (
            <Link
              ...
              className={
                textBlack
                  ? "text-base font-semibold hidden lg:block hover:underline hover:underline-offset-8 hover:duration-300 hover:transition-all text-black"
                  : "text-base font-semibold hidden lg:block hover:underline hover:underline-offset-8 hover:duration-300 hover:transition-all"
              }
            >
              {data.name}
            </Link>
        ...
        <section className="flex gap-2  items-center">
          <h1
            className={
              textBlack
                ? "weight-900 text-2xl cursor-pointer text-black"
                : "weight-900 text-2xl cursor-pointer"
            }
          >
            toko online
          </h1>
        ...
        <section
          className={
            textBlack
              ? "flex gap-5 items-center text-black"
